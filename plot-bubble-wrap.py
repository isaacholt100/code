...
scale_factor = 2.0 # change this to adjust how close the matched cusp points are. with delta_p = 0.2, delta_q = 0.8, sf~0.8 gives overlapping "bubbles", sf~2 gives nicely spaced "bubbles"
