...
scale_factor = 2.0 # change this to adjust how close the matched cusp points are. with delta_inner = 0.2, delta_outer = 0.8, sf~0.8 gives overlapping "bubbles", sf~2 gives nicely spaced "bubbles"
...
z_plot = [matched_cusps_approx_weight(delta_inner=0.2, delta_outer=0.8, matched_cusp_points=matched_cusp_points, x=x) for x in input_values]
